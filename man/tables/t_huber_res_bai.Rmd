...
**Table S2.** Robust measures of central tendency of resilience indices for tree-growth (BAI) grouped by drought events, site and interaction. Measures of central tendency are M-estimators based on Huber's Psi (see material and methods). 95 % confidence intervals using 3000 bootstrap are included between parentheses.
*Total* corresponds to the average of 2005 and 2012.
...
mraw_a <- read.csv(here::here("/out/anovas_resilience/huber_bai", "robust_mhuber_agg_a.csv"), header = TRUE)
...
# Datos agrupados para todos los sitios 
mraw_b <- read.csv(here::here("/out/anovas_resilience/huber_bai", "robust_mhuber_agg_b.csv"), header = TRUE)
