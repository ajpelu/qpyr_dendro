...
In this work we combined remote sensing information and dendroecological methods to evaluate the drought impacts in canopy greenness (as a proxy to primary growth) and tree-radial growth of a Mediterranean tree species (*Quercus pyrenaica*) located in the rear-edge of their distribution. 

Remote sensing can be used for studying droughts impacts on ecosystems [@Deshayes2006; @Zhang2013; @AghaKouchak2015; @McDowell2015; @Norman2016]. Drought impacts on vegetation using remote sensing have been analyzed at different scales [@VicenteSerrano2013; @Assal2016], and for Mediterranean area there were studies covering all region [@Gouveia2017] and others focused on local scales [@Lloret2007; @VicenteSerrano2007; @Gouveia2012; @Zribi2016]. Vegetation indices obtained from satellite, such us EVI (*Enhanced Vegetation Index*) are used as a proxy for assessing vegetation functioning and aboveground net primary production [@Huete2002], and changes in the patterns of these indices are considered as an idicator of the forest response to external environmental factors, such us droughts [*e.g.* @VicenteSerrano2013; @Vicca2016]. 

Tree-ring width is a widely used proxy for tree vitality [@Fritts1976; @Dobbertin2005; @Bhuyan2017] and the analysis of annual-tree ring widths can be used to study changes in growth as response to drought at the individiual tree-scale [@Gazol2018]. 

Several studies han combindado 

Several studies have combined the use of satellite information with dendrochronological information to study the effect of droughts on vegetation
