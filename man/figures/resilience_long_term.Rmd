...
sevRt_site <- plotrelsite(sdfsite, v = "rt", x = 'd_severity', label = 'disturb_year', site = "site",
                 titulo = "Rt", coord_eqX = Inf) + xlab('') + ylab('') + xlim(5,25)
...
ggsave(filename = here::here("./man/figures/svg/fig_6.jpg"), 
       dpi = 300,  plot=res_long_term_sites, width=8.5, height=7)
...
ggsave(filename = here::here("./man/figures/svg/fig_6_95.jpg"), 
       dpi = 300,  plot=res_long_term_sites95, width=9, height=7)
