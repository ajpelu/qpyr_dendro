...
## Esto no es necesario, es solamente para calcular lm y demás por tibles
...
```{r}
# SAVE as eps 
saveImage(res_long_term_sites_all, path="./man/figures/svg/", dpi=300, w=25, h=14, fig= "fig_6", u = "cm") 
```
...
res_long_term_sites_no95 <-  g + 
  geom_text(data = dfauxno95, 
            aes(x = 12, y = 0.2, label = eq), 
            inherit.aes = FALSE, parse = TRUE, 
            col = "gray40") + 
  xlim(5,25) + ylim(0.1,3.5)
```


```{r}
# SAVE as eps 
saveImage(res_long_term_sites_no95, path="./man/figures/svg/", dpi=300, w=25, h=14, fig= "fig_s8", u = "cm") 
