...
sevRt_site <- plotrelsite(sdfsite, v = "rt", x = 'd_severity', label = 'disturb_year', site = "site",
             titulo = "Rt", coord_eqX = Inf, xLM = -Inf, yLM = 0.5) + xlab('') + ylab('') + xlim(5,25)

sevRs_site <- plotrelsite(sdfsite, v = "rs", x = 'd_severity', label = 'disturb_year', site = "site",
                 titulo = "Rs", coord_eqX = -Inf, xLM = 10, yLM = 0.5) + xlab('') + ylab('') + xlim(5,25)
...
ggsave(filename = here::here("./man/figures/svg/fig_6_95.jpg"), 
       dpi = 300,  plot=res_long_term_sites, width=25, height=14, units = "cm")
ggsave(filename = here::here("./man/figures/svg/fig_6_95.eps"), 
       dpi = 300,  plot=res_long_term_sites, width=25, height=14, units = "cm")
ggsave(filename = here::here("./man/figures/svg/fig_6_95.svg"), 
       dpi = 300,  plot=res_long_term_sites, width=25, height=14, units = "cm")
