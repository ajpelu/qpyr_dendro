...
* Calcular el BAI por cada árbol haciendo la media de crecimiento (RW) a nivel de árbol. Para el cálculo de la media de crecimiento por árbol utilizamos la siguiente función [./script/R/rw_byTree.R](/script/R/rw_byTree.R)) creada específicamente para ello. 
