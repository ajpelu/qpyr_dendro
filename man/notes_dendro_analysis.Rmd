...
Se han construido cronologías de perturbaciones siguiendo la aproximación de aproximación del método *Percent Increase*  [@Nowacki1997](varios ejemplos se pueden ver en [@GeaIzquierdo2014, @Dorado2017]). Utilizamos la función `computeGC` (código aquí: [./script/R/computeGC.R](/script/R/gea/computeGC.R)). En concreto hemos llevado a cabo lo siguiente: 
...
* Algunas ventajas del método de [@Nowacki1997] (según [@Altman2014]):
...
En una revisión sobre métodos para detectar disturbance events, [@Rubio2014] encontró que el método mas común es el de *runneing mean*, es decir, la comparación la tasa de crecimiento de grupos de anillos adyacentes.  
