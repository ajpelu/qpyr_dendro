...
Our results showed differences for greenness and tree-growth between northern and southern oak populations (Table 3). Las poblaciones del norte, que presentan condiciones mas secas (Tabla 1), se vieron mas afectadas por los eventos de sequía. Así por ejemplo vimos que las anomalías estandarizadas de EVI fueron mas negativas en la población del norte durante la sequía de 2005 (mayor intensidad de browing en 2005 para el norte). 
...
When we explored the chracteristics of the southern sites, we firstly observed a difference in elevation. @Bhuyan2017, in a recent work across the European continent, found a clearly effect of elevation on the resistance to drought of several tree-species, where stands located at higher elevations were less drought sensitive. The higher values of tree growth that we observed in CA-High site could be related with lower water stress at high-elevation sites, since moisture availability is a key factor limiting tree growth for *Q. pyrenaica* [@GeaIzquierdo2014]. In fact, the differences in available water of soils could explain our results. [@CoboDiaz2017], who studied microbiota of this location in an elevational gradient, found higher values of available water of the forest soils located on high elevation compared with those located at low elevations. In this sense, a remarkably observation supporting this idea, is the presence of a traditional irrigation ditches located uphill from the CA-High site. In most of the high-mountain watersheds of Sierra Nevada, there is a system of historical irrigation channels, know as *acequias de careo*, that was used since Middle Age to cultivated these valleys [@MartinCivantos2014, @MartinCivantos2016]. These ditches run through the hillsides of valleys releasing water through several points that filtrate the water to recharge the aquifer and then irrigates the foot of the slopes [@MartinCivantos2014, @Jodar2017]. There is a ditch (*Acequia de la Era Alta*) located uphill the CA-High site, which functions from March to June [@RuizRuiz2017]. It brings water from snowmelt and from a nearby stream, soaking the *Q. pyrenaica* forests. 
Finally another idea to consider is the different degree of anthropic impact related to elevation. 


Aunque nuestros sitios presenten valores similares de competencia, la historia de manejo humano puede ser diferente, y en parte se relaciona con la altitud. Así en zonas altas encontramos un menor impacto humano que en las zonas bajas. Esto ocurre 

Another reason that could explain the higher values of BAI of CA-High site is el grado diferente de impacto antrópico. En nuestros resultados vemos como los bosques situados a mayor altitud presentan un menor impacto antrópico. Esto puede ser simplemente por el hecho de que estos bosques estén menos accesibles ---> ojo y la idea de que son bosque relativamente jóvenes 
---> Gráfica 
Our sampled sited showed similar tree competence levels (Table 1), but ... impacto antrópico diferente  
...
Tanto en el greenness como en el growth, encotramos direfencias para el greenness y el crecimiento entre las poblaciones situadas al norte y al sur.  
...
# 4) Punto fuerte metodológico (VALID)


La vegetación es un reflejo de las condiciones ambientales, y los efectos de la sequía en la vegetación se pueden ver tanto con información de satélite (hablar del browning), como con información mas de campo (hablar aquí de lo del BAI). 


Nuestros resultados

La combinación de metodologías que hemos empleado para evaluar la resiliencia de la vegetación frente a los eventos de sequía 



La vegetación es un reflejo de las condiciones ambientales, y los efectos de la sequía en la vegetación se pueden ver tanto con información de satélite, como con información mas de campo (hablar aquí de lo del BAI).  


Los efectos de la sequía sobre la vegetación pueden observarse usando información procedente de diferentes aproximaciones metodológicas [see @Norman2016 for a review]. 

[información procedente de remote sensing (RS)[@Zhang2013; @AghaKouchak2015], información dendrochronologica (), 

o combinando estas y otras metodologías [see @Norman2016 for a review] 
...
The effects of drought on vegetation can be observed using information from several methodological approaches [see @Norman2016 for a review]. Several works revealed the utility of remote-sensing or dendrochronology to quantify the dorught impacts on vegetation at different spatial and temporal scales (). 



Exiten trabajos que han utilizado remote-sensing o la dendrochronology para analizar los efectos de las sequías sobre la vegetación a diferentes escalas espaciales y temporales ( ). Asimismo, algunos otros trabajos han utilizado conjuntamente estas dos metodologias, y han visto que existe de forma general una relació
a positive relationship between vegetation indices derived from remote sensing and annual tree growth [@VicenteSerrano2016; @Bhuyan2017b], 


In general, a positive relationship between NDVI in the growing season and RWI was seen for many forests in our study.




Positive relationship between inter-annual NDVI variability and annual tree growth [@VicenteSerrano2016] 


Esta relación positiva también la encuentra 
...
Nuestro trabajo muestra una combinación de métodos 


Finalmente, destacamos la aproximación metodológica que hemos llevado a cabo. 

La vegetación es un reflejo de las condiciones ambientales, y los efectos de la sequía se pueden ver tanto con información de satélite (hablar del browning), como con información mas de campo (hablar aquí de lo del BAI). 
...
# Diferencias que hemos detectado usando RS y RWI (en resiliencias)
* Relacionar con datos de Gazol et al. 2018 


# Jusfiticación de uso de ambos métodos
...
## De forma genérica y para el rear-edge 
...
## Sensibilidades diferentes de cada metodología 
