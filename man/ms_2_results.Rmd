...
Although no significant differences were observed in the resistance of the oak growth to both drought events (F = 6.0189; p = 0.019; table 2; Figure 3b), the 2005 drought reduced growth more than 2012 did (Rt = 0.721 and 0.819 respectively). Northern population showed resistance values lower than southern ones, especially for 2005 drought event where the growth was reduced to 44.5 % of the preceding period. 
