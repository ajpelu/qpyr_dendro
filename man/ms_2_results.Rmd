...
*Q. pyrenaica* forest showed significantly lower resistance (*Rt*) to the 2005 drought event than to that in 2012 (Table 3; Figure 3a). The 2005 drought reduced the greenness of oaks to a 85.8 % respect the reference period while the 2012 reduced it 94.3 % (Table S1). Southern populations showed significantly higher values of resistance to drought than northern ones (Table 3), except for 2012 where non-significant differences were recorded (Table S1. Figures 3a, 4a). 
...
The oak forests recovered (*Rc*) their greenness significantly more rapidly after the 2005 drought than after 2012 (Tables 3, S1). In the 3-year period after the 2005 drought, greenness achieved was 112 % (Rc = 1.12) and after 2012 was 105.7 % (Rc = 1.057) (Table S1). A similar recovery after the 2005 and 2012 drought event was observed for southern populations (p = 0.2453; Figure 4a), whilst the northern populations showed a significantly greater recovery after the 2005 drought than after the 2012 drought (Figure 4a). 
