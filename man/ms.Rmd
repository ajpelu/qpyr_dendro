...
Greenness and tree-growth of *Q. pyrenaica* showed different sensitivity to severe droughts. The exploration of the average reduction for the 2005 and 2012 droguht events
revaled that EVI was reduced to 90.25 % (Table S1), whereas BAI was reduced to 70.83 % (Table S2). This suggests a lower sensitivity of the greenness than tree-growth to drought, particularly for sites under drier climate. For instance, during 2005 drought event, the BAI were reduced to 44.5 % respect to that of the preceding period in northern site (SJ), whereas the EVI was reduced to 81.9 % for the same site during the same drought event (Tables S1 and S2). 
...
Causas: 
Gazol
EVI of the understory (Dioniosio) 
Different scales 
