...
Rear-edge populations live in environmental narrow margins, and small variations in environmental conditions can increase the vulnerability of the species [@Hampe2005]. For instance, higher vulnerability to drought is often assumed for rear-edge populations [@MartinezVilalta2018], however some studies showed different findings [@Cavin2017; @Granda2017], as our results suggest, with high values of resilience for populations of *Q. pyrenaica* located in its rear-edge. This would be related with the definition of the marginal population.
...
* sitaución en Sierra Nevada
* Mayor resiliencia (mayor crecimiento) los robles mas altos 

* Existencia de aportes extra de humedad. Las acequias 



- Por un lado una alta disponibilidad de agua. Conocemos que esta especies es mas sensitive a la humedad del suelo que otras especies arbóreas mediterráneas (GeaFEM)
