...
EVI data consits of 16-day maximun value composite images (23 per year) of the EVI value with a spatial resolution of 231 m x 231 m. We selected the pixels covering the distribution of *Q. pyrenaica* forests in Sierra Nevada (*n* = 928 pixels). MODIS EVI Data from Collection 6 were obtanied using Google Earth Engine platform for the period 2000 - 2016. 

OJITO---------- reescribir esto

A quality filter was applied to select only valid values of EVI. 

First we used information from the Quality Assesment band (QA band) to filter out those values affected by high content of aerosols, clouds, shadows, snow or water; 
