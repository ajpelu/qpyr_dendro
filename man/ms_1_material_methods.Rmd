...
Incluir datos de muestreo de competencia
...
To study the response of growth to the inter-annual variability of climate (short-term response) we used pre-withened residual chronologies (growth index, GIres) calculated from biweight means of ratios between raw growth measurements and individual cubic splines with a 50 % frecuency cutoff at 30 years [@Fritts1976]. 
