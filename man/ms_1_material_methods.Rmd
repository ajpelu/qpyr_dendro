...
Data were obtained using a Google Earth Engine script (:red_circle: cite gists) for the 2000 - 2015 period. We selected the pixels covering the distribution of Quercus pyrenaica forests in Sierra Nevada (*n* = 928 pixels). The EVI data are geometrically and atmospherically corrected and include information about the quality ass.... 
:red_circle: 
