...
themeR <- list(
  ...
  theme(
    ...
    plot.title = element_text(hjust = -0.05, size = 16, margin = margin(t=-5, b=1))),
  scale_shape_manual(labels = item_site, guide = guide_legend(title = NULL),
    values=c("0_N" = 19, "1_S" = 21, "3_CA-High" = 22, "4_CA-Low" = 15, "2_SJ" = 19)), 
  scale_color_manual(labels = item_site, guide = guide_legend(title = NULL),
    values=c("0_N" = 'black', "1_S" = "blue", "3_CA-High" = 'blue', "4_CA-Low" = 'blue', "2_SJ" = 'black')),
  scale_fill_manual(labels = item_site, guide = guide_legend(title = NULL),
    values=c("0_N" = 'black', "1_S" = "white", "3_CA-High" = 'white', "4_CA-Low" = 'blue', "2_SJ" = 'black')),
  scale_linetype_manual(labels = item_site, guide = guide_legend(title = NULL),
                        values=c("solid","solid","solid","solid", "solid")),
  scale_size_manual(labels = item_site, guide = guide_legend(title = NULL),
