...
themeR <- list(
  ...
  theme(
    ...
    plot.title = element_text(hjust = -0.05, size = 16, margin = margin(t=-5, b=1))),
  scale_shape_manual(values=c(19, 21, 17, 22, 15)),
  scale_color_manual(values=c('black', "blue", 'black','blue','blue')),
  scale_fill_manual(values=c('black', 'white', 'black','white','blue')),
  scale_linetype_manual(values=c("solid","solid","solid","solid", "solid")),
  scale_size_manual(values=c(2,2,2.5, 2.5, 2.5)),
