...
cp <- ggplot(df, aes(x=as.factor(hmonth), y=csum)) + 
  ...
  annotate("text", label = "2004-2005", x = 2, y = 500, size = 4, colour = "blue") + 
  annotate("text", label = "2011-2012", x = 2, y = 550, size = 4, colour = "red") + 
  annotate("text", label = "mean 1950-2015", x = 3, y = 600, size = 4, colour = "black") +
  theme(panel.grid = element_blank())
```
