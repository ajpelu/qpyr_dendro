...
- [] Figure 3. Resilience metrics
- [] Figure 4. BAI chronologies 

- [] Figure 5. Residual chronologies --> Supplementary 
...
```{r, warning=FALSE, dpi = 100, fig.height=5}
# ```{r, warning=FALSE, out.extra='angle=90', fig.height=4, fig.width=2}
...
plotrel <- function(df, v, x, label, XLab, YLab, coordX_eq, coordY_eq, titulo){
  ...
  ggplot(df, aes_string(y=paste0(v, "_mean_mean"), x=x, label=label)) + 
    ...
    geom_point(size=2, pch = 21, colour="black", fill="white") + 
    theme_bw() + 
    xlab(XLab) + ylab(YLab) + 
    geom_text_repel() + 
