...
# nsmooth: es el tamaño de la wavelength (0.67*long serie; ej.: 30 years)
...
computeSpline <- function (rwdf, nsmooth){
  ...
  for (i in cores) {
    ...
    # 1 # Select ring width serie 
    rws <- rwdf[[id_core]]
    
    # 2 # Prepare data to detrend
    ...
    # 4 # Join another detrened series
    rwl_rwi <- cbind(rwl_rwi, serie_suavizada)
  }
  return(rwl_rwi)
}     

rwi_sj <- computeSpline(sj, nsmooth = 30)
