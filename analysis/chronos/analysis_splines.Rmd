...
# SJ 
res_4_sj <- rwiResilience(bai_sj, event_years = dyears, window = 4)
res_3_sj <- rwiResilience(bai_sj, event_years = dyears, window = 3)
res_2_sj <- rwiResilience(bai_sj, event_years = dyears, window = 2)

# caL
res_4_caL <- rwiResilience(bai_caL, event_years = dyears, window = 4)
res_3_caL <- rwiResilience(bai_caL, event_years = dyears, window = 3)
res_2_caL <- rwiResilience(bai_caL, event_years = dyears, window = 2)

# caH
res_4_caH <- rwiResilience(bai_caH, event_years = dyears, window = 4)
res_3_caH <- rwiResilience(bai_caH, event_years = dyears, window = 3)
res_2_caH <- rwiResilience(bai_caH, event_years = dyears, window = 2)
```
...
rwiResilience <- function(rwi_tree, event_years)
  ...
  for (i in event_years){
    ...
    rwi_df <- dfmelt %>% group_by(disturb, tree) %>% 
...
## Download data from E-OBS
# http://www.ecad.eu/download/ensembles/download.php#datafiles 

library(loadeR)


# Define dir and list nc files 
mydir <- '/Users/ajpelu/Downloads/climaobs' 

list.files(mydir, pattern = "\\.nc$")
