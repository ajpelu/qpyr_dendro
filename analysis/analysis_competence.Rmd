...
for (i in 1:length(focal_trees)){ 
  ...
  dnft <- filter(df, sp== 'Focal')$dn # normal diameter of focal tree    
  # ----------
...
```{r}
source(paste0(getwd(), '/script/R/get_coords_trees.R')) 
