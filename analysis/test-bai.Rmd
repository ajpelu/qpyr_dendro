...
sj_tree <- rw_byTree(sj, snc =c(2,2,2))
ca_tree <- rw_byTree(ca, snc =c(2,2,2))

sjL_tree <- rw_byTree(sjL, snc =c(2,2,2))
sjH_tree <- rw_byTree(sjH, snc =c(2,2,2))
caL_tree <- rw_byTree(caL, snc =c(2,2,2))
caH_tree <- rw_byTree(caH, snc =c(2,2,2))
