...
out3 <- out3 %>% dplyr::select(mivar, mean_CA_High, sd_CA_High, tukey_CA_High,
                 mean_CA_Low, sd_CA_Low, tukey_CA_Low,
                 mean_SJ_High, sd_SJ_High, tukey_SJ_High,
                 mean_SJ_Low, sd_SJ_Low, tukey_SJ_Low)
