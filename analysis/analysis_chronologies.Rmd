...
source(paste0(getwd(), '/script/R/chrono_bai.R'))
source(paste0(getwd(), '/script/R/suaviza_cronos.R'))
```
...
* Luego calculamos la correlación entre series :red_circle: ask to Isabel and guillermo 
