...
ggsave(plot=pgrowht, width=8, height = 4,
       filename=paste0(di, 'out/mean_resilience/bai_events.pdf')) 
```
...
homo %>% pander()
write.csv(homo, 
          file=paste0(di, '/out/anovas_resilience/bai/homocedasticidad.csv'), row.names = F)
```
...
homo_log %>% pander()
write.csv(homo_log, 
          file=paste0(di, '/out/anovas_resilience/bai/homocedasticidad_log.csv'), row.names = F)
```
...
```{r, echo=FALSE}
pdf(paste0(di, '/out/mean_resilience/bai/interaction_plotsSE.pdf'), width=9, height = 9)
grid.arrange(plot_mdSE, plot_msSE, plot_mdsSE, ncol=3)
dev.off()

pdf(paste0(di, '/out/mean_resilience/bai/interaction_plotsCI.pdf'), width=9, height = 9)
grid.arrange(plot_mdCI, plot_msCI, plot_mdsCI, ncol=3)
dev.off()
```
...
write.csv(aovas_coeff, file=paste0(di, '/out/anovas_resilience/bai/anovas_statistics.csv'), row.names = F)
