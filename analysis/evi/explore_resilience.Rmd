...
```{r}
# Read data
raw_evires <- read.csv(here::here("/data/resilience","resilience_evi.csv"), header = TRUE, sep = ',')

# add data of pop
anomalias <- read.csv(here::here("/data/anomalies", "anomalias_evimean.csv"), header = TRUE, sep = ',')
...
### mean + sd
```{r plot_resiliences_evi_sd,fig.width = 12, fig.height=12}
...
```{r, echo=FALSE}
pdf(here::here('/out/mean_resilience/evi', 'interaction_plotsSE.pdf'), width=9, height = 9)
grid.arrange(plot_mdSE, plot_msSE, plot_mdsSE, ncol=3)
dev.off()

pdf(here::here('/out/mean_resilience/evi','interaction_plotsCI.pdf'), width=9, height = 9)
grid.arrange(plot_mdCI, plot_msCI, plot_mdsCI, ncol=3)
dev.off()
```
...
write.csv(aovas_coeff, file=here::here('/out/anovas_resilience/evi', 'anovas_statistics.csv'), row.names = F)
...
write.csv(aovas_model_summary, 
          file=file=here::here('/out/anovas_resilience/evi','anovas_summary_modelos.csv'), row.names = F)
...
normtestA %>% pander()
write.csv(normtestA, 
          file=here::here('/out/anovas_resilience/evi','normo_disturb_year.csv'), row.names = F)
```
...
normtestB %>% pander()
write.csv(normtestB, 
          file=here::here('/out/anovas_resilience/evi','normo_site.csv'), row.names = F)
```
...
write.csv(normtestAB, 
          file=here::here('/out/anovas_resilience/evi','/normo_disturb_year_site.csv'), row.names = F)
```
...
homo %>% pander()
write.csv(homo, 
          file=here::here('/out/anovas_resilience/evi','homocedasticidad.csv'), row.names = F)
```
...
homo_log %>% pander()
write.csv(homo_log, 
          file=here::here('/out/anovas_resilience/evi','homocedasticidad_log.csv'), row.names = F)
```
...
homo_log1 %>% pander()
write.csv(homo_log, 
          file=here::here('/out/anovas_resilience/evi','homocedasticidad_log_plus_1.csv'), row.names = F)
```
...
pdf(here::here('/out/resilience_robust/evi/','robust_plot_evi_drought.pdf'), width=9, height = 9)
robust_plot_evi_drought 
dev.off()
```
...
pdf(here::here('/out/resilience_robust/evi/', 'robust_plot_evi_site.pdf'), width=9, height = 9)
robust_plot_evi_site 
dev.off()
```
...
```{r}
# Export data 
write.csv(mhuber, file=here::here('/out/anovas_resilience/huber_evi','robust_mhuber.csv'), row.names = F)
write.csv(mhuber_agg, file=here::here('/out/anovas_resilience/huber_evi','robust_mhuber_agg.csv'), row.names = F)
write.csv(mhuber_a, file=here::here('/out/anovas_resilience/huber_evi','robust_mhuber_a.csv'), row.names = F)
write.csv(mhuber_agg_a, file=here::here('/out/anovas_resilience/huber_evi','robust_mhuber_agg_a.csv'), row.names = F)
write.csv(mhuber_b, file=here::here('/out/anovas_resilience/huber_evi','robust_mhuber_b.csv'), row.names = F)
write.csv(mhuber_agg_b, file=here::here('/out/anovas_resilience/huber_evi','robust_mhuber_agg_b.csv'), row.names = F)

write.csv(pairwise, file=here::here('/out/anovas_resilience/huber_evi','/robust_pairwise.csv'), row.names = F)
write.csv(trimmedanovas, file=here::here('/out/anovas_resilience/huber_evi','trimmed_anovas.csv'), row.names = F)
```
