---
title: "Comparison ANOVAS stand features"
...
# Seleccionamos: 
# * distance independet: BA, Stand Densisty (std) 
# * distance dependent: Site ratio proportional to distance (srd); as in Gea2014 Foreco 320:70 & Lorimer 

compe_sel <- compe %>% dplyr::select(ba, std, srd, pd, site)
```
